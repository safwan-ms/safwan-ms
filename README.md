<img width="100%" height="200px" src="https://miro.medium.com/v2/resize:fit:1400/1*aniyNTcHORbvDiLGUzJSsQ.gif" />
...
- 🔭 I’m currently working on *Deepseek Clone using NextJS*
...
## 💻 Frontend
[![My Skills](https://skillicons.dev/icons?i=js,react,nextjs,ts,tailwind,nextjs,redux,html,css)](https://skillicons.dev)

## 🧠 Backend
[![My Skills](https://skillicons.dev/icons?i=nodejs,nestjs,express,mongodb,mysql,postgres,npm,prisma,py)](https://skillicons.dev)

## 🧰 Tools
[![My Skills](https://skillicons.dev/icons?i=bash,git,docker,linux,github,postman,powershell,ubuntu,vscode)](https://skillicons.dev)
